      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>MAKEZAA</span>
          </a>
          ...
          <div className="hidden md:flex items-center gap-4">
            <a href="mailto:hello@makezaa.com" className={`transition-all duration-500 ${isScrolled ? "text-xs text-foreground/70 hover:text-foreground" : "text-sm text-white/70 hover:text-white"}`}>
              Contact
            </a>
            <a href="#book-meeting">
              <Button
